...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 text-left text-lg font-medium text-foreground transition hover:text-foreground/90 [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
